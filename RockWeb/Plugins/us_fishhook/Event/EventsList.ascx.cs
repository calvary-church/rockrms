...
namespace RockWeb.Blocks.Event
{
    ...
    /// </summary>
    [DisplayName( "Custom Events List with Calendar and Filters" )]
    [Category( "Fishhook" )]
    [Description( "Renders a list of events using Lava. Includes options for filtering by date, audience and campus." )]
    ...
    public partial class CalendarLava : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            this.AddConfigurationUpdateTrigger( upnlEventsList );
        }
        ...
        public void ResetFilters(Control parent)
        {

		        //Loop through all the controls present on the web page/form        
		        foreach (Control ctrl in parent.Controls)
		        {
		            ...
		            else if (ctrl.GetType() == typeof(RockDropDownList))
		            {
		                ((RockDropDownList)(ctrl)).SelectedIndex = 0;
		            }
        ...
        private void BindData()
        {
            ...
            else if ( campusIdList.Any())
            {
                ...
                qry = qry.Where( c => !c.CampusId.HasValue || campusIdList.Contains( c.CampusId.Value ) );
						...
						// Filter by Category
						int? categoryId = ddlCategory.SelectedValueAsInt();
						if ( categoryId.HasValue )
						{
						    qry = qry.Where( i => i.EventItem.EventItemAudiences.Any( c => c.DefinedValueId == categoryId.Value ) );
						}
